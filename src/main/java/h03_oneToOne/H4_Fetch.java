...
SessionFactory sf=new Configuration().configure("hibernate.cfg.xml").addAnnotatedClass(H2_Gunluk.class).addAnnotatedClass(H1_Kisi.class).buildSessionFactory();
		...
		String sorgu="SELECT k.kisiAd, g.yazilar , k.kisiYas FROM kisiler k INNER JOIN gunlukler g ON k.kisiId=g.kisi_id";
		...
		//günlük tablosundan öğrenci adını günlük adını kayıtların ogrenci yaşını getir (HQL)  
		
		String sorgu1="SELECT k.kisiAd, g.yazilar, k.kisiYAs FROM H1_Kisi k JOIN H2_Gunluk g ON k.kisiId=g.kisi";
